<template>
    <section class="mt-5">
        ...
        <h2 class="regular m-2">Maybe want to read something?</h2>
            ...
            <div v-for="(item, i) of sortedArticles" :key="i" class="col-sm-12 col-md-6 col-lg-4 m-2 d-block mx-auto mb-3 mt-3">
                <div class="text-center article-item rounded">
                    <NuxtLink :to="`/blog/${item.slug}`">
                        <img :src="item.image" width="720px" height="auto" class="card-img-top article-image p-2" :alt="item.title" :title="item.title">
                    </NuxtLink>
